...
import 'package:flowchat/features/media/presentation/view/image_preview_screen.dart';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
       ...
       pageBuilder: (context, state) => Zoomintransition.zoom(const ImagePreviewScreen(), state),
      ),
      // GoRoute(
